            ...
            <div className="main-layout">
                ...
                <div className="main-view">
                    <div className="info-list">
                        ...
                        {postListString?JSON.parse(postListString).slice((curPage - 1) * postsPerPage,curPage*postsPerPage).map(x => (
                            <div key={x.post} className="list-item">
                                <div key={x.post+1}><Link className="content-link list-item-title" to={'/student-view/course/' + courseId + '/discussion/topic/' + topicId+'/post/'+x.post}>{x.title}</Link></div>
                    ...
                    <div className="float-right">
                        <Link className="content-link" to={'/student-view/course/'+courseId+'/discussion/topic/'+topicId+'/create'}>Create a post</Link>
                    </div>
                </div>
            </div>
        </div>
