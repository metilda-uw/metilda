...
class PitchArtContainer extends React.Component<Props, State> {
  ...
  constructor(props: Props) {
    ...
    this.state = {
      minPitch:
        this.props.minPitch || PitchArtContainer.DEFAULT_MIN_ANALYSIS_PITCH,
      maxPitch:
        this.props.maxPitch || PitchArtContainer.DEFAULT_MAX_ANALYSIS_PITCH,
      minTime:
        this.props.minPitch || PitchArtContainer.DEFAULT_MIN_ANALYSIS_TIME,
      maxTime:
        this.props.maxPitch || PitchArtContainer.DEFAULT_MAX_ANALYSIS_TIME,
      ...
      <div>
        <div className="col s5">
          ...
          <div className="metilda-pitch-art-container-control-list">
            ...
            />
            <TimeRange
              initMinTime={this.state.minTime}
