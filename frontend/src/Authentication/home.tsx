    ...
    return (
      <div className="Home">
        ...
        <p>
          ...
          interested to learn the endangered language called <b>
            Blackfoot
          </b>{" "}
          and <b />
        ...
        <p>
          <b>
            Platform for Endangered Language Documentation and Analysis (PELDA)
          </b>{" "}
          facilitates the use of linguistic tools called <b>Praat</b> and{" "}
          <b>ELAN</b> <b />
          by integrating these tools into the application interface. The PELDA
          interface allows users to process endangered language recordings and
          extract their audio <b />
          features to facilitate effective language documentation and analysis.
          It also allows users <b />
          to select a specific time range of an audio file, add hierarchical
          tiers, and add <b />
          annotation (comments/notations) details based on specific
          requirements. In addition, <b />
          all annotation-related information can be saved in an XML file on the
          system and <b />
