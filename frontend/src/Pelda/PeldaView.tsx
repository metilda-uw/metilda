...
export class PeldaView extends React.Component<PeldaViewProps, State> {
  ...
  callBackSelectionInterval = (
    childSoundLength: number,
    childMinAudioTime: number,
    childMaxAudioTime: number,
    childSelectStartTime: number,
    childSelectEndTime: number,
    ...
    if (
      eafTimeInterval !== null &&
      eafStartTimeElement !== null &&
      eafEndTimeElement !== null
    ) {
  ...
  callBackEafTierData = async (
    isTier1Enabled: boolean,
    tier1text: string,
    isTier2Enabled: boolean,
    tier2text: string,
    isTier3Enabled: boolean,
    tier3text: string,
    isTier4Enabled: boolean,
    tier4text: string,
    isTier5Enabled: boolean,
    tier5text: string,
    isTier6Enabled: boolean,
    tier6text: string,
    startTime: number,
    endTime: number
  ) => {
    ...
    if (
      this.state.tier1Value !== "" ||
      this.state.tier2Value !== "" ||
      this.state.tier3Value !== "" ||
      this.state.tier4Value !== "" ||
      this.state.tier5Value !== "" ||
      this.state.tier6Value !== ""
    ) {
      const isOk: boolean = window.confirm(
        "The existing content of tiers will be lost. Are you sure you want to view eaf file data?"
      );
      ...
      if (isOk) {
        ...
        if (
          ...
          eafStartTimeElement.innerText =
            "EAF start time: " + startTime.toFixed(1);
        ...
        NotificationManager.info(
          "Please save your exisiting annotation details!!"
        );
      }
    } else {
      await this.setState({
  ...
  renderSpeakers = () => {
    ...
    return (
      <PeldaAudioAnalysis
        speakerIndex={index}
        key={`audio-analysis-${index}-${this.props.speakers[index].uploadId}`}
  ...
  getEnergy() {
    ...
    fetch(`/get-energy/${this.props.speakers[0].uploadId}`, request)
      ...
      .then(() => alert("Energy: " + this.state.energy))
      .catch(console.log);
  }
  ...
  countVoicedFrames() {
    ...
    fetch(
      `/pitch/count-voiced-frames/${this.props.speakers[0].uploadId}`,
      request
    )
      .then((response) => response.json())
      .then((data) =>
      ...
      .then(() => alert(this.state.voicedFrames))
      .catch(console.log);
  }
  ...
  getPitchValueAtTime() {
    ...
    if (time !== null) {
      fetch(
        `/pitch/value-at-time/${this.props.speakers[0].uploadId}/${time}`,
        request
      )
        .then((response) => response.json())
        .then((data) =>
        ...
        .then(() => alert(this.state.pitchValueAtTime))
        .catch(console.log);
    }
  }
  ...
  getPitchValueInFrame() {
    ...
    if (frame !== null) {
      fetch(
        `/pitch/value-in-frame/${this.props.speakers[0].uploadId}/${frame}`,
        request
      )
        .then((response) => response.json())
        .then((data) =>
        ...
        .then(() => alert(this.state.pitchValueInFrame))
        .catch(console.log);
    }
  }
  ...
  getLowestFrequency() {
    ...
    fetch(`/spectrum/get-bounds/${this.props.speakers[0].uploadId}`, request)
      ...
      .then(() => alert("Lowest Frequency: " + this.state.lowFrequency + " Hz"))
      .catch(console.log);
  }
  ...
  getMeanIntensity() {
    ...
    fetch(`/intensity/get-bounds/${this.props.speakers[0].uploadId}`, request)
      ...
      .then(() => alert("Mean Intensity: " + this.state.meanIntensity + " dB"))
      .catch(console.log);
  }
  ...
  getNoOfFrames() {
    ...
    fetch(
      `/formant/number-of-frames/${this.props.speakers[0].uploadId}`,
      request
    )
      .then((response) => response.json())
      .then((data) =>
      ...
      .then(() => alert(this.state.noOfFrames))
      .catch(console.log);
  }
  ...
  getNoOfFormants() {
    ...
    if (frame !== null) {
      fetch(
        `/formant/number-of-formants/${this.props.speakers[0].uploadId}/${frame}`,
        request
      )
        .then((response) => response.json())
        .then((data) =>
        ...
        .then(() => alert(this.state.noOfFormants))
        .catch(console.log);
    }
  }
  ...
  getFormantFrequencyAtTime() {
    ...
    if (formant !== null && time !== null) {
      fetch(
        `/formant/value-at-time/${this.props.speakers[0].uploadId}/${formant}/${time}`,
        request
      )
        .then((response) => response.json())
        .then((data) =>
        ...
        .then(() => alert(this.state.formantValueAtTime))
        .catch(console.log);
    }
  }
  ...
  getMinimumHarmonicity() {
    ...
    if (startTime !== null && endTime !== null) {
      fetch(
        `/harmonicity/get-min/${this.props.speakers[0].uploadId}/${startTime}/${endTime}`,
        request
      )
        .then((response) => response.json())
        .then((data) =>
        ...
        .then(() => alert(this.state.minHarmonicity))
        .catch(console.log);
    }
  }
  ...
  getMaximumHarmonicity() {
    ...
    if (startTime !== null && endTime !== null) {
      fetch(
        `/harmonicity/get-max/${this.props.speakers[0].uploadId}/${startTime}/${endTime}`,
        request
      )
        .then((response) => response.json())
        .then((data) =>
        ...
        .then(() => alert(this.state.maxHarmonicity))
        .catch(console.log);
    }
  }
  ...
  getHarmonicityValueAtTime() {
    ...
    if (time !== null) {
      fetch(
        `/harmonicity/value-at-time/${this.props.speakers[0].uploadId}/${time}`,
        request
      )
        .then((response) => response.json())
        .then((data) =>
        ...
        .then(() => alert(this.state.harmonicityValueAtTime))
        .catch(console.log);
    }
  }
  ...
  getNoOfPeriods() {
    ...
    if (startTime !== null && endTime !== null) {
      fetch(
        `/pointprocess/number-of-periods/${this.props.speakers[0].uploadId}/${startTime}/${endTime}`,
        request
      )
        .then((response) => response.json())
        .then((data) =>
        ...
        .then(() => alert(this.state.noOfPeriods))
        .catch(console.log);
    }
  }
  ...
  getNoOfPoints() {
    ...
    fetch(
      `/pointprocess/number-of-points/${this.props.speakers[0].uploadId}`,
      request
    )
      .then((response) => response.json())
      .then((data) =>
      ...
      .then(() => alert(this.state.noOfPoints))
      .catch(console.log);
  }
  ...
  getJitter() {
    ...
    if (startTime !== null && endTime !== null) {
      fetch(
        `/pointprocess/get-jitter/${this.props.speakers[0].uploadId}/${startTime}/${endTime}`,
        request
      )
        .then((response) => response.json())
        .then((data) =>
        ...
        .then(() => alert(this.state.localJitter))
        .catch(console.log);
    }
  }
  ...
  addTiers() {
    if (
      this.props.speakers[0].uploadId !== null &&
      ...
      if (this.state.selectEndTime - this.state.selectStartTime >= 1) {
        ...
        if (element !== null && timeInterval !== null) {
          ...
          if (
            elementTier1 !== null &&
            elementTier1.getAttribute("class") === "hidden"
          ) {
            elementTier1.setAttribute("class", "unhidden");
            const textbox1 = document.getElementById("textbox1");
            if (textbox1 !== null) {
            ...
            elementTier2 !== null &&
            elementTier2.getAttribute("class") === "hidden"
          ) {
            elementTier2.setAttribute("class", "unhidden");
            const textbox2 = document.getElementById("textbox2");
            if (textbox2 !== null) {
            ...
            elementTier3 !== null &&
            elementTier3.getAttribute("class") === "hidden"
          ) {
            elementTier3.setAttribute("class", "unhidden");
            const textbox3 = document.getElementById("textbox3");
            if (textbox3 !== null) {
            ...
            elementTier4 !== null &&
            elementTier4.getAttribute("class") === "hidden"
          ) {
            elementTier4.setAttribute("class", "unhidden");
            const textbox4 = document.getElementById("textbox4");
            if (textbox4 !== null) {
            ...
            elementTier5 !== null &&
            elementTier5.getAttribute("class") === "hidden"
          ) {
            elementTier5.setAttribute("class", "unhidden");
            const textbox5 = document.getElementById("textbox5");
            if (textbox5 !== null) {
            ...
            elementTier6 !== null &&
            elementTier6.getAttribute("class") === "hidden"
          ) {
            elementTier6.setAttribute("class", "unhidden");
            const textbox6 = document.getElementById("textbox6");
            if (textbox6 !== null) {
        ...
        NotificationManager.info(
          "Please select a time window of atleast 1 second to add annotation details!"
        );
      }
    }
  }
  ...
  removeTiers = async (event: any) => {
    ...
    if (element !== null && element.getAttribute("class") !== "hidden") {
      if (
        ...
        const isOk: boolean = window.confirm(
          "The content of tiers will be lost." +
  ...
  removeTier = async (event: any) => {
    ...
    if (buttonId === "removeTier1") {
      ...
      const isOk: boolean = window.confirm(
        isTextboxEmpty + "Are you sure you want to remove Tier 1?"
      );
    ...
    if (buttonId === "removeTier2") {
      ...
      const isOk: boolean = window.confirm(
        isTextboxEmpty + "Are you sure you want to remove Tier 2?"
      );
    ...
    if (buttonId === "removeTier3") {
      ...
      const isOk: boolean = window.confirm(
        isTextboxEmpty + "Are you sure you want to remove Tier 3?"
      );
    ...
    if (buttonId === "removeTier4") {
      ...
      const isOk: boolean = window.confirm(
        isTextboxEmpty + "Are you sure you want to remove Tier 4?"
      );
    ...
    if (buttonId === "removeTier5") {
      ...
      const isOk: boolean = window.confirm(
        isTextboxEmpty + "Are you sure you want to remove Tier 5?"
      );
    ...
    if (buttonId === "removeTier6") {
      ...
      const isOk: boolean = window.confirm(
        isTextboxEmpty + "Are you sure you want to remove Tier 6?"
      );
    ...
    if (this.state.selectEndTime - this.state.selectStartTime >= 1) {
      if (
        ...
        if (element !== null && element.getAttribute("class") === "unhidden") {
          ...
          if (
            elementTier1 !== null &&
            elementTier1.getAttribute("class") === "unhidden"
          ) {
            if (this.state.tier1Value !== "") {
              tiersValue += "\nTier 1: " + this.state.tier1Value;
            } else {
              NotificationManager.info(
                "Tier1 content cannot be empty. Please either enter the content or remove the tier!"
              );
              return;
            }
          }
          ...
          if (
            elementTier2 !== null &&
            elementTier2.getAttribute("class") === "unhidden"
          ) {
            if (this.state.tier2Value !== "") {
              tiersValue += "\nTier 2: " + this.state.tier2Value;
            } else {
              NotificationManager.info(
                "Tier2 content cannot be empty. Please either enter the content or remove the tier!"
              );
              return;
            }
          }
          ...
          if (
            elementTier3 !== null &&
            elementTier3.getAttribute("class") === "unhidden"
          ) {
            if (this.state.tier3Value !== "") {
              tiersValue += "\nTier 3: " + this.state.tier3Value;
            } else {
              NotificationManager.info(
                "Tier3 content cannot be empty. Please either enter the content or remove the tier!"
              );
              return;
            }
          }
          ...
          if (
            elementTier4 !== null &&
            elementTier4.getAttribute("class") === "unhidden"
          ) {
            if (this.state.tier4Value !== "") {
              tiersValue += "\nTier 4: " + this.state.tier4Value;
            } else {
              NotificationManager.info(
                "Tier4 content cannot be empty. Please either enter the content or remove the tier!"
              );
              return;
            }
          }
          ...
          if (
            elementTier5 !== null &&
            elementTier5.getAttribute("class") === "unhidden"
          ) {
            if (this.state.tier5Value !== "") {
              tiersValue += "\nTier 5: " + this.state.tier5Value;
            } else {
              NotificationManager.info(
                "Tier5 content cannot be empty. Please either enter the content or remove the tier!"
              );
              return;
            }
          }
          ...
          if (
            elementTier6 !== null &&
            elementTier6.getAttribute("class") === "unhidden"
          ) {
            if (this.state.tier6Value !== "") {
              tiersValue += "\nTier 6: " + this.state.tier6Value;
            } else {
              NotificationManager.info(
                "Tier6 content cannot be empty. Please either enter the content or remove the tier!"
              );
              return;
            }
          }
        ...
        const isOk: boolean = window.confirm(
          "The following are the annotation details: " +
            tiersValue +
        ...
        if (isOk) {
          ...
          if (
            ...
            fetch(
              `/annotation/${eafFileName}/${this.props.speakers[0].uploadId}/${this.state.selectStartTime}/${this.state.selectEndTime}/${tier1text}/${tier2text}/${tier3text}/${tier4text}/${tier5text}/${tier6text}`,
              request
            )
              ...
              .then((eafData) => {
                uploadEaf(
                  eafFileName,
                  this.props.speakers.map((item) => item.fileIndex),
                  eafData,
                  this.props.firebase
                );
              })
        ...
        <div className="peldaview">
          ...
          <div className="metilda-page-content">
            ...
            <div id="audioLength">
              ...
              {this.state.soundLength > 0 && (
                <p id="audio-length-label">
                  {this.state.soundLength.toFixed(5)} s
                </p>
              )}
            </div>
            <div className="leftMenuBar">
              ...
              <div className="menu">
                ...
                <div className="drop-content">
                  <button onClick={() => this.countVoicedFrames()}>
                    {" "}
                    Count voiced frames{" "}
                  </button>
                  <button onClick={() => this.getPitchValueAtTime()}>
                    {" "}
                    Get value at time{" "}
                  </button>
                  <button onClick={() => this.getPitchValueInFrame()}>
                    {" "}
                    Get value in frame{" "}
                  </button>
                </div>
              ...
              <div className="menu">
                ...
                <div className="drop-content">
                  <button onClick={() => this.getLowestFrequency()}>
                    {" "}
                    Get lowest frequency{" "}
                  </button>
                  <button onClick={() => this.getHighestFrequency()}>
                    {" "}
              ...
              <div className="menu">
                ...
                <div className="drop-content">
                  <button onClick={() => this.getMinimumIntensity()}>
                    {" "}
                    Get minimum intensity{" "}
                  </button>
                  <button onClick={() => this.getMaximumIntensity()}>
                    {" "}
                    Get maximum intensity{" "}
                  </button>
                  <button onClick={() => this.getMeanIntensity()}>
                    {" "}
                    Get mean intensity{" "}
                  </button>
                </div>
              ...
              <div className="menu">
                ...
                <div className="drop-content">
                  <button onClick={() => this.getNoOfFrames()}>
                    {" "}
                    Get number of frames{" "}
                  </button>
                  <button onClick={() => this.getNoOfFormants()}>
                    {" "}
                    Get numbers of formants{" "}
                  </button>
                  <button onClick={() => this.getFormantFrequencyAtTime()}>
                    {" "}
                    Get value at time{" "}
                  </button>
                </div>
              ...
              <div className="menu">
                ...
                <div className="drop-content">
                  <button onClick={() => this.getMinimumHarmonicity()}>
                    {" "}
                    Get minimum{" "}
                  </button>
                  <button onClick={() => this.getMaximumHarmonicity()}>
                    {" "}
                    Get maximum{" "}
                  </button>
                  <button onClick={() => this.getHarmonicityValueAtTime()}>
                    {" "}
                    Get value at time{" "}
                  </button>
                </div>
              ...
              <div className="menu">
                ...
                <div className="drop-content">
                  <button onClick={() => this.getNoOfPeriods()}>
                    {" "}
                    Get number of periods{" "}
                  </button>
                  <button onClick={() => this.getNoOfPoints()}>
                    {" "}
                    Get number of points{" "}
                  </button>
                  <button onClick={() => this.getJitter()}>
                    {" "}
                    Get jitter (local){" "}
                  </button>
                </div>
              ...
              <div className="menu">
                ...
                <div className="drop-content">
                  ...
                  <button
                    ...
                    id="saveannotationbutton"
                    className="saveannotation"
                  >
                    Save Annotation
                  </button>
                </div>
            ...
            {this.state.selectStartTime >= 0 &&
              this.state.selectEndTime >= 0 &&
            ...
            <div id="eaf-interval" className="unhidden">
              <p id="eaf-start-time" className="unhidden"></p>
              <p id="eaf-end-time" className="unhidden"></p>
            </div>
            ...
            <div id="elan-annotation" className="hidden">
              <div id="tier1label" className="hidden">
                <p>
                  ...
                  <input
                    id="textbox1"
                    onChange={(e) => this.handleTierValue(e)}
                    value={this.state.tier1Value}
                  ...
                  >
                    <i className="material-icons right">delete</i>Delete Tier 1
                  </button>
                </p>
              </div>
              ...
              <div id="tier2label" className="hidden">
                <p>
                  ...
                  <button
                    ...
                    onClick={this.removeTier}
                  >
                    <i className="material-icons right">delete</i>Delete Tier 2
                  </button>
                </p>
              </div>
              ...
              <div id="tier3label" className="hidden">
                <p>
                  ...
                  <button
                    ...
                    onClick={this.removeTier}
                  >
                    <i className="material-icons right">delete</i>Delete Tier 3
                  </button>
                </p>
              </div>
              ...
              <div id="tier4label" className="hidden">
                <p>
                  ...
                  <button
                    ...
                    onClick={this.removeTier}
                  >
                    <i className="material-icons right">delete</i>Delete Tier 4
                  </button>
                </p>
              </div>
              ...
              <div id="tier5label" className="hidden">
                <p>
                  ...
                  <button
                    ...
                    onClick={this.removeTier}
                  >
                    <i className="material-icons right">delete</i>Delete Tier 5
                  </button>
                </p>
              </div>
              ...
              <div id="tier6label" className="hidden">
                <p>
                  ...
                  <button
                    ...
                    onClick={this.removeTier}
                  >
                    <i className="material-icons right">delete</i>Delete Tier 6
                  </button>
                </p>
              </div>
            </div>
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withAuthorization(authCondition)(PeldaView as any));
