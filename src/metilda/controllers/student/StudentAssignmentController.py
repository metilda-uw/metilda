...
# @app.route('/student-view/assignment/file/create', methods=["POST"])
# def student_assignment_create_file():
#     with Postgres() as connection:
...
# @app.route('/student-view/assignment/file/delete', methods=["POST"])
# def student_assignment_delete_file():
#     with Postgres() as connection:
...
def student_read_submission():
    with Postgres() as connection:
        query = 'select time,content,grade,max_grade from assignment_submissions where user_id=%s and assignment=%s'
...
def student_update_submission():
    with Postgres() as connection:
        query = 'update assignment_submissions set content=%s,time=%s where user_id=%s and assignment=%s'
        args = (request.form['content'],request.form['time'],request.form['user'],request.form['assignment'])
        connection.execute_update_query(query, args)
